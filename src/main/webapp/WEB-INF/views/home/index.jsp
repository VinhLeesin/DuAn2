        ...
        <div class="col-9">
            ...
            <nav aria-label="Page navigation example">
                <ul class="pagination">
                    ...
                    <li class="page-item"><a class="page-link" href="/?page=${page.number-1}">Previous</a></li>
                    <li class="page-item"><a class="page-link" href="/?page=${page.number+1}">Next</a></li>
                    <li class="page-item"><a class="page-link" href="/?page=${page.totalPages-1}">Last</a></li>
                </ul>
                <ul>
